...
using Point = boost::geometry::model::d3::point_xyz<double, boost::geometry::cs::cartesian>;
...
class LEDPixel {
  public:
    ...
    friend auto operator << (std::ostream &out, const LEDPixel<ColorT> &L) -> std::ostream & {
